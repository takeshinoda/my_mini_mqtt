use std::fmt;
use super::{
    BinaryData, Bits, ExtractValue, QoS, TwoByteInteger, UTF8EncodedString,
};
use crate::errors;
use crate::packets;
...
pub struct Connect {
    pub fixed_header: packets::FixedHeader, // 3.1.1 CONNECT Fixed Header subsection
...
pub struct VariableHeader {
    ...
    pub properties: packets::Properties,           // 3.1.2.11 CONNECT Properties subsection
}
...
impl VariableHeader {
    ...
    ) -> Result<VariableHeader, errors::Error> {
        Ok(VariableHeader {
            protocol_name,
            protocol_version,
            connect_flags,
...
impl ConnectFlags {
    pub fn new(flags: Bits) -> Result<ConnectFlags, errors::Error> {
...
pub struct Payload {
    ...
    pub will_properties: Option<packets::Properties>, // 3.1.3.2 Will Properties subsection
...
impl Payload {
    pub fn new(
        ...
        will_properties: Option<packets::Properties>,
